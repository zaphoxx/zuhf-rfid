...
On Oct 22, 2016 10:07 PM, "Simon Monk" <srmonk@gmail.com> wrote:
	...
	RFID_CC1101 library in a 'recipe'. Your library is by far the easiest to use of 
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SpiMode(byte config)
{
  byte tmp;
...
****************************************************************/
byte RFID_CC1101::SpiTransfer(byte value)
{
  SPDR = value;
  while (!(SPSR & (1<<SPIF))) ;
  return SPDR;
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SpiWriteReg(byte addr, byte value)
{
	digitalWrite(SS_PIN, LOW);
	while(digitalRead(MISO_PIN));
	SpiTransfer(addr);
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SpiWriteBurstReg(byte addr, byte *buffer, byte num)
{
	byte i, temp;
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SpiStrobe(byte strobe)
{
	digitalWrite(SS_PIN, LOW);
	while(digitalRead(MISO_PIN));
	SpiTransfer(strobe);
...
****************************************************************/
byte RFID_CC1101::SpiReadReg(byte addr) 
{
	byte temp, value;
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SpiReadBurstReg(byte addr, byte *buffer, byte num)
{
	byte i,temp;
...
*OUTPUT       :status value
****************************************************************/
byte RFID_CC1101::SpiReadStatus(byte addr) 
{
	byte value,temp;
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::RegConfigSettings(byte f) 
{
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SendData(byte *txBuffer,byte size)
{
...
*OUTPUT       :none
****************************************************************/
void RFID_CC1101::SetReceive(void)
{
...
****************************************************************/
byte RFID_CC1101::CheckReceiveFlag(void)
{
...
****************************************************************/
byte RFID_CC1101::ReceiveData(byte *rxBuffer)
{
	byte size;
	byte status[2];
